...
SHARED_APPS = (
    ...
    "customers",                # Your app for tenant models
    "tailwind",                 # Optional
    "theme",                    # Optional
    "django.contrib.contenttypes",
    "django.contrib.staticfiles",
...
TENANT_APPS = (
    ...
    "django.contrib.sessions",
    "django.contrib.messages",
    "tracker",                  # Your main app for tenant-specific functionality
)
...
# === Database (✅ Correctly configured for django-tenants) ===
DATABASES = {
    'default': dj_database_url.config(
        default=os.environ.get('DATABASE_URL'),
        conn_max_age=600
